<template>
  <o-layout has-layers>
    ...
    <main>
      <od-sider />
      <div class="bg-gray-20 md:ml-sider">
...
import { OdSider } from "~/components/Sider";
import routeToMetaTitle from "~/utils/pathToMeta.js";
...
export default {
  ...
  head() {
    return {
      title: `${routeToMetaTitle(this.$route.fullPath)}`,
    };
  },
};
</script>
